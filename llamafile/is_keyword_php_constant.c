...
/* Command-line: gperf --output-file=llamafile/is_keyword_php_constant.c llamafile/is_keyword_php_constant.gperf  */
...
#line 1 "llamafile/is_keyword_php_constant.gperf"
...
const char *
is_keyword_php_constant (register const char *str, register size_t len)
{
  struct stringpool_t
    {
