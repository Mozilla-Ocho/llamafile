...
/* Command-line: gperf --output-file=llamafile/is_keyword_ruby_constant.c llamafile/is_keyword_ruby_constant.gperf  */
...
#line 1 "llamafile/is_keyword_ruby_constant.gperf"
...
const char *
is_keyword_ruby_constant (register const char *str, register size_t len)
{
  struct stringpool_t
    {
      ...
      char stringpool_str8[sizeof("__LINE__")];
      char stringpool_str12[sizeof("__ENCODING__")];
      char stringpool_str13[sizeof("__FILE__")];
    };
