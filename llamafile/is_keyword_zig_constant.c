...
/* Command-line: gperf --output-file=llamafile/is_keyword_zig_constant.c llamafile/is_keyword_zig_constant.gperf  */
...
#line 1 "llamafile/is_keyword_zig_constant.gperf"
...
const char *
is_keyword_zig_constant (register const char *str, register size_t len)
{
  struct stringpool_t
    {
