...
/* Command-line: gperf --output-file=llamafile/is_keyword_lua_constant.c llamafile/is_keyword_lua_constant.gperf  */
...
#line 1 "llamafile/is_keyword_lua_constant.gperf"
...
const char *
is_keyword_lua_constant (register const char *str, register size_t len)
{
  struct stringpool_t
    {
      char stringpool_str2[sizeof("_G")];
      char stringpool_str3[sizeof("nil")];
      char stringpool_str4[sizeof("true")];
      char stringpool_str5[sizeof("false")];
      char stringpool_str8[sizeof("_VERSION")];
      char stringpool_str10[sizeof("arg")];
    };
